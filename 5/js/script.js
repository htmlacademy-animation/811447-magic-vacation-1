...
/* harmony import */ var _modules_text_animation__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/text-animation */ "./source/js/modules/text-animation.js");
// modules
...
const animationIntroTitle = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_11__["default"](`.intro__title`, `active`);
setTimeout(()=>{
  animationIntroTitle.runAnimation();
}, 500);

const animationIntroDate = new _modules_text_animation__WEBPACK_IMPORTED_MODULE_11__["default"](`.intro__date`, `active`);
setTimeout(()=>{
