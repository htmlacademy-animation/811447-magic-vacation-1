  ...
  function drawSeeCalf() {
    ...
    if (airplaneCanvas.getContext) {
      ...
      const drawAirplaneCanvas = () => {
        ...
        airplaneContext.drawImage(airplaneImg, Math.round((windowWidth - sizesCanvas.airplane.width) / 2 + airplaneTranslateX), Math.round((windowHeight - sizesCanvas.airplane.height) / 2 + airplaneTranslateY + 120), sizesCanvas.airplane.width * airplaneScale, sizesCanvas.airplane.height * airplaneScale);
